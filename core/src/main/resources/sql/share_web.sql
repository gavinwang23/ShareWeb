...
-- ----------------------------
-- Table structure for favorite_article_station
-- ----------------------------
DROP TABLE IF EXISTS `favorite_article_station`;
CREATE TABLE `favorite_article_station` (
  ...
  `article_title` varchar(64) NOT NULL COMMENT '文章名',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of favorite_article_station
-- ----------------------------
BEGIN;
INSERT INTO `favorite_article_station` VALUES (1, '11111', '11111', '大大大');
INSERT INTO `favorite_article_station` VALUES (2, '11111', '222', '嘻嘻嘻');
INSERT INTO `favorite_article_station` VALUES (3, '11111', 'xixixi', 'dsadad');
COMMIT;
...
CREATE TABLE `index_information_station` (
  ...
  `user_name` varchar(32) NOT NULL COMMENT '用户名',
  `index_article_name` varchar(64) DEFAULT NULL COMMENT '首页文章名称',
  `index_picture_address` varchar(64) DEFAULT NULL COMMENT '首页图片地址',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `state` enum('EN','DIS') DEFAULT NULL COMMENT '状态',
...
-- ----------------------------
BEGIN;
INSERT INTO `users_station` VALUES (1, '11111', '	b0baee9d279d34fa1dfd71aadb908c3f', 'ADMIN', '2019-12-25 07:43:27', '2019-09-30 19:50:35', 'NORMAL', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL);
